...
The Legacy API implementation of this command is identical to [the Software API implementation](../../../software_api/km_api/mouse/buttons/btn_state_change_callback.md).
